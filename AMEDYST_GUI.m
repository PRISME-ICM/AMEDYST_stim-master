...
if ~isempty(figPtr) % Figure exists so brings it to the focus
    ...
    %KND
    if debug
        set(handles.checkbox_WindowedScreen,'Value',1);
    end
    ...
    b_adapt_high.tag = 'pushbutton_ADAPT_Reward';
    ...
    b_adapt_low.tag = 'pushbutton_ADAPT_Punishment';
